...
- Standard fingerprint stack: the matched compatibility pair is `libfprint-t1bridge 1.94.100-7` and `fprintd-t1bridge 1.94.5-3`. The fprintd package requires that exact T1Bridge libfprint package version and the libfprint 2 ABI.
